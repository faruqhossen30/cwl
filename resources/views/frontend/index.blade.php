...
<head>
  ...
  <link rel="stylesheet" href="{{asset('tender/./assets/css/theme.css')}}">
  <link rel="stylesheet" href="{{asset('tender/./assets/css/responsive.css')}}">
...
<body style="background-image: url('{{asset('tender/assets/images/900204.jpg')}}');background-repeat: no-repeat;background-size: cover;">

  <div class="loader" id="pre-loader">
    <img src="{{asset('tender/./assets/images/loader.gif')}}" alt="">
  </div>
  <!-- start header -->
  <div class="__header">
    <!-- startd header top -->
    ...
    <div class="__header_middle">
      <div class="container __flex">
        ...
        <a href="{{url('/')}}">
          <img src="{{asset('tender/assets/images/logo1.png')}}" class="__site_logo" alt="">
        </a>
        ...
        <ul class="__header_middle_right __flex">
          ...
          <li>
            <a href="{{url('cliend')}}" class="__signupbtn">
    ...
    <div class="__header_nav">
      <div class="container __flex">
        <ul class="__flex" id="__nav_ele">
          ...
          <li>
            <a href="{{url('travel')}}">Tourism in Bangladesh</a>
          </li>
          <li>
  ...
  <script type="text/javascript" src="{{asset('tender/./assets//js/theme.js')}}"></script>
