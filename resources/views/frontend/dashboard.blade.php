  ...
  <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active img-fluid">
        <img src="{{asset('tender/assets/images/slider/img1.jpg')}}" class="img-fluid" style="background-img:cover;width:100%;" alt="">
      ...
      <img src="{{asset('tender/assets/images/slider/img2.jpg')}}" class="img-fluid" style="background-img:cover;width:100%;" alt="">
        <!-- <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item img-fluid">
      <img src="{{asset('tender/assets/images/slider/img3.jpg')}}" class="img-fluid" style="background-img:cover;width:100%;" alt="">
        <!-- <div class="carousel-caption d-none d-md-block">
