        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('travel.create')}}" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('tenderup.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>upload tender</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('tenderup.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>manage tender</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('egpback.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Training</p>
                </a>
              </li>
           ...
           <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('cliendback.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Client</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('dropidea.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage idea</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('country.create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create location</p>
                </a>
              </li>
